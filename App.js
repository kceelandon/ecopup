...
export default function App() {
  ...
  const renderScene = ({ route }) => {
    switch (route.key) {
      ...
      case 'second':
          return <SecondRoute storeName ={currStore} wasteScore={currWaste} productScore={currProduct} commScore={currCommunity} />;
      case 'third':
          return <ThirdRoute/>;
      case 'fourth':
          return <FourthRoute/>;
  ...
  */
  ...
  const setScores = (store, waste, wasteDesc, product, productDesc, community, communityDesc, name) => {
      ...
      <MapView style={styles.map} 
        ...
        {locationData.map((marker, index) => (
          <MapView.Marker
            ...
            onPress={() => setScores(marker.name, marker.waste, marker['waste-desc'], marker.product, marker['product-desc'], marker.community, marker['community-desc'], marker.name)}
          >
